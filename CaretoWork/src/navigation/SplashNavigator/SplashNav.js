...
const SplashNav = () => {
  const { authUser, dbWorker, loading, queryWorker, setLoading } =
    useAuthContext();
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      {!loading ? (
        dbWorker ? (
          <>
            ...
            <Stack.Group screenOptions={{ presentation: "modal" }}>
              <Stack.Screen
                name="EditUser2Screen"
                component={EditUser2Screen}
              />
              <Stack.Screen
        ...
        <Stack.Screen name="SplashingScreen" component={SplashScreen} />
      )}
    </Stack.Navigator>
  );
};
